      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:540px;background-color:#ffffff;border-radius:12px;overflow:hidden;">
        ...
        <tr>
          <td style="padding:32px;">
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px;background-color:#f7f5f2;border-radius:8px;width:100%;">
              <tr>
                <td style="padding:16px;">
                  <p style="margin:0;font-size:14px;line-height:1.6;color:#64748B;">Sign-in time</p>
            ...
            <p style="margin:0 0 24px;font-size:16px;line-height:1.6;">If you didn&rsquo;t sign in, please contact us immediately at <a href="mailto:${SUPPORT_EMAIL}" style="color:#0B4F6C;text-decoration:underline;">${SUPPORT_EMAIL}</a> so we can secure your account.</p>
