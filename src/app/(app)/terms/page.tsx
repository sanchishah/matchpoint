  ...
  return (
    <div className="py-16">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <p className="text-sm text-[#717171] mb-10">Last updated: January 2025</p>

        <div className="prose prose-sm max-w-none text-[#4A4A4A] space-y-6">
          <section>
            <h2 className="font-[family-name:var(--font-playfair)] text-xl text-[#2A2A2A] mb-3">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-playfair)] text-xl text-[#2A2A2A] mb-3">2. Service Description</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="font-[family-name:var(--font-playfair)] text-xl text-[#2A2A2A] mb-3">3. Payments & Refunds</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="font-[family-name:var(--font-playfair)] text-xl text-[#2A2A2A] mb-3">4. User Conduct</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="font-[family-name:var(--font-playfair)] text-xl text-[#2A2A2A] mb-3">5. Limitation of Liability</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="font-[family-name:var(--font-playfair)] text-xl text-[#2A2A2A] mb-3">6. Changes to Terms</h2>
            <p className="leading-relaxed">
