    ...
    <div className="py-16">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <div className="prose prose-sm max-w-none text-[#4A4A4A] space-y-6">
          <section>
            <h2 className="font-[family-name:var(--font-playfair)] text-xl text-[#2A2A2A] mb-3">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-playfair)] text-xl text-[#2A2A2A] mb-3">2. How We Use Your Information</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="font-[family-name:var(--font-playfair)] text-xl text-[#2A2A2A] mb-3">3. Data Sharing</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="font-[family-name:var(--font-playfair)] text-xl text-[#2A2A2A] mb-3">4. Data Security</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="font-[family-name:var(--font-playfair)] text-xl text-[#2A2A2A] mb-3">5. Your Rights</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="font-[family-name:var(--font-playfair)] text-xl text-[#2A2A2A] mb-3">6. Contact</h2>
            <p className="leading-relaxed">
